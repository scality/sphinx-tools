...
const OLD_DOCS_FEEDBACK_PROJECT_ID = "07e4358a-627c-4fd5-bbed-181f476eacc8";
...
function displayExpectedFeedbackButton(api) {
    ...
    api.hide(OLD_DOCS_FEEDBACK_PROJECT_ID);
...
window.onUsersnapCXLoad = function (api) {
    api.init().then(() => displayExpectedFeedbackButton(api));
